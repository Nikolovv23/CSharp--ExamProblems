...
namespace NauticalCatchChallenge.Models
{
    public abstract class Diver : IDiver
    {
        ...
        public IReadOnlyCollection<string> Catch => catched.AsReadOnly();
        ...
        {
            return $"Diver [ Name: {Name}, Oxygen left: {OxygenLevel}, Fish caught: {catched.Count}, Points earned: {CompetitionPoints} ]";
        }
    }
}
